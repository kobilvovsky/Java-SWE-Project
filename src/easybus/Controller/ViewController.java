...
public class ViewController
{
    ...
    public class CloseListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            String value = view.getTable().getModel().getValueAt(row, column).toString();
        ...
        switch(model.getSelected()) {
            case CAR:
                ...
                for(int i = 0; i < model.getCarModel().getSize(); i++) {
                    data[i][j++] = Integer.toString(model.getCarModel().getCars().getElement(i).getLicenseNum());
                    data[i][j++] = model.getCarModel().getCars().getElement(i).getModel();
                    data[i][j++] = Integer.toString(model.getCarModel().getCars().getElement(i).getYear());
                    data[i][j++] = Integer.toString(model.getCarModel().getCars().getElement(i).getFuelConsumption());
                    data[i][j++] = Integer.toString(model.getCarModel().getCars().getElement(i).getYearlyCost());
                    j = 0;
                }
                break;
            case STATION:
